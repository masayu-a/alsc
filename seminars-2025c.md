...
- 開催期日: 2024年8月20日 (火) 13:00〜17:25、21日 (水) 9:00〜17:00
...
- 参加申し込み: 7月15日正午までに [フォーム](https://docs.google.com/forms/d/e/1FAIpQLSdFizrIDPm_F4Qjc0686-dVbgia2hQF2gkjpmUIC23-98pQnw/viewform) よりお申し込みください。
...
- 内容: 学生や研究者を対象にした音声生成に関する計測技術ハンズオンセミナーを開催いたします。
音声科学研究にとって声帯振動や調音運動の計測は研究の基礎となる技術ですが、計測のためには特殊な装置が必要です。昨年に引き続き、日本国内で利用できる非侵襲的な計測装置のほぼ全てをまとめて体験できる機会を作ります。実際に装置を使ってデータ収集や解析を実習し、また研究例を紹介します。
...
- スケジュール (予定):
  ...
  - 9月3日
    ...
    - 13:00～14:40 超音波画像診断装置と新型ヘッドセットの紹介および解説 (孫、北村、能田) とデータ解析実習 (孫)
    - 15:00～16:00 調音運動計測の言語学的応用・超音波画像の舌輪郭プロット方法紹介 (溝口)
    - 16:00～17:00 国立国語研究所における研究倫理審査 (浅原)
